    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-xs text-[var(--color-text-body)] select-none">
      ...
      <div className="p-6 rounded-[4px] card-standard flex flex-col gap-5 text-justify leading-relaxed">
        ...
        <section className="flex flex-col gap-2">
          <h3 className="font-bold text-[var(--color-gold-bright)] text-xs">1. Academic Discipline</h3>
          <p>
        ...
        <section className="flex flex-col gap-2">
          <h3 className="font-bold text-[var(--color-gold-bright)] text-xs">2. Uniform and Dress Code</h3>
          <p>
        ...
        <section className="flex flex-col gap-2">
          <h3 className="font-bold text-[var(--color-gold-bright)] text-xs">3. Mobile Device Policy</h3>
          <p>
        ...
        <section className="flex flex-col gap-2">
          <h3 className="font-bold text-[var(--color-gold-bright)] text-xs">4. Accuracy of Registrations</h3>
          <p>
