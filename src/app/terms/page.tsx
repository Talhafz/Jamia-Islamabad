...
export default function TermsPage() {
  return (
    <div className="w-full bg-[var(--color-emerald-bg)] min-h-screen py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-xs text-[var(--color-text-body)] select-none">
        ...
        <div className="card-standard p-6 rounded-2xl bg-[var(--color-panel)] shadow-md flex flex-col gap-5 text-justify leading-relaxed">
          
          <div className="flex items-center gap-2 text-[var(--color-gold-bright)] font-bold text-sm border-b border-[var(--color-emerald-mid)] pb-2">
            <BookOpen className="w-5 h-5 text-[var(--color-teal-accent)]" />
            <span>Code of Conduct & Admission Agreement</span>
          </div>

          <section className="flex flex-col gap-2">
            <h3 className="font-bold text-[var(--color-gold-primary)] text-xs">1. Academic Discipline</h3>
          ...
          <section className="flex flex-col gap-2">
            <h3 className="font-bold text-[var(--color-gold-primary)] text-xs">2. Uniform and Dress Code</h3>
            <p className="text-[var(--color-text-body)]">
          ...
          <section className="flex flex-col gap-2">
            <h3 className="font-bold text-[var(--color-gold-primary)] text-xs">3. Mobile Device Policy</h3>
            <p className="text-[var(--color-text-body)]">
          ...
          <section className="flex flex-col gap-2">
            <h3 className="font-bold text-[var(--color-gold-primary)] text-xs">4. Accuracy of Registrations</h3>
            <p className="text-[var(--color-text-body)]">
