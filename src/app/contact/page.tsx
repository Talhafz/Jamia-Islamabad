        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
          ...
          <div className="md:col-span-5 flex flex-col gap-6">
            <div className="p-6 rounded-[4px] card-standard flex flex-col gap-4">
              <h3 className="text-base font-extrabold text-[var(--color-gold-bright)] border-l-2 border-[var(--color-gold-primary)] pl-2">Office Address</h3>
          ...
          <div className="md:col-span-7">
            {submitted ? (
              <div className="p-8 bg-[var(--color-emerald-deep)] border border-[var(--color-teal-accent)]/30 rounded-[4px] text-center flex flex-col items-center gap-4 animate-scale-up">
                ...
                <h3 className="text-lg font-bold text-[var(--color-gold-bright)]">Inquiry Sent Successfully</h3>
              ...
              <form onSubmit={handleSubmit} className="p-6 rounded-[4px] card-standard flex flex-col gap-4">
                <h3 className="text-base font-extrabold text-[var(--color-gold-bright)] border-l-2 border-[var(--color-gold-primary)] pl-2 mb-2">Send an Inquiry</h3>
                
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-bold text-[var(--color-text-muted)]">Full Name *</label>
                    <input
                      type="text"
                      required
                      value={name}
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs font-bold text-[var(--color-text-muted)]">Email Address *</label>
                    <input
                      type="email"
                      required
                      value={email}
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-bold text-[var(--color-text-muted)]">Subject</label>
                  <input
                    type="text"
                    value={subject}
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs font-bold text-[var(--color-text-muted)]">Message *</label>
                  <textarea
                    required
                    rows={4}
                    value={message}
