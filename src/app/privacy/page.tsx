      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-xs text-[var(--color-text-body)] select-none">
        ...
        <div className="card-standard p-6 rounded-2xl bg-[var(--color-panel)] shadow-md flex flex-col gap-5 text-justify leading-relaxed">
          ...
          <section className="flex flex-col gap-2">
            <h3 className="font-bold text-[var(--color-gold-primary)] text-xs">1. Local Draft Persistence</h3>
          ...
          <section className="flex flex-col gap-2">
            <h3 className="font-bold text-[var(--color-gold-primary)] text-xs">2. Profile Photo and Digital Signatures</h3>
            <p className="text-[var(--color-text-body)]">
          ...
          <section className="flex flex-col gap-2">
            <h3 className="font-bold text-[var(--color-gold-primary)] text-xs">3. External Sharing</h3>
            <p className="text-[var(--color-text-body)]">
